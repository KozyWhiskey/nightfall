...
- [x] Buildings in v1 web — **6** (Lantern Keep, Training Hall, Tavern, Forge, Scriptorium, Stores); Wardhouse+ later. See [haven-buildings.md](../systems/haven-buildings.md).
- [x] Starting buildings — **Lantern Keep only.** See [haven-buildings.md](../systems/haven-buildings.md).
...
- [x] Stress — **light Gloom meter** (pillars suppress; creep from skipped events / Emberglass hoard / low light; high Gloom → bad things + light Strain). Not full DD afflictions. See [gloom-and-stress.md](../systems/gloom-and-stress.md).
