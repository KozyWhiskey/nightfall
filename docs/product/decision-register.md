...
| `art.production` | Build 1 character-art scope | Begin with precomposed class standees and ID-keyed item illustrations. Full nine-slot hero compositing is not a Build 1 dependency; only a bounded Vanguard main-hand/offhand overlay proof may precede a later expansion decision. | [Technical Asset Contract](../art/technical-asset-contract.md) |
