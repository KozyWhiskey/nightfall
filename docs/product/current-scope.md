...
- Pillarhouse starts built. Cinder Forge, Quiet House, and Wardyard are visible from founding but require returned resources. Ember Vault and Wayfarer award blueprints only in this slice.
- First content packs: Band-1 enemies, four polished events, first procedural gear/affix pool, and ten scroll patterns.
- Rewards are fully identified choices. The slice has no carry-capacity/bag system; all non-chested expedition possessions are at risk on a wipe.
- Future-facing simulation support only: deterministic seeded state, declarative effects, future HP costs, and summon-capable entities.
...
- Blood magic, lifesteal, summons, permanent auras, Stun/Poison scrolls, and other advanced school content.

## Documentation convention

Older documents may describe the intended broader game. They must label features outside this page as **Future / deferred**, never as must-ship or vertical-slice behavior. Do not implement a deferred feature merely because its longer-term design exists.
