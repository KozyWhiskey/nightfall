...
| `enemies/gloom_spore.webp` | Gloom Spore Band-1 exploder standee | Candidate v1; registry-wired for mirrored hostile and live standee-state review pending approval |
