...
const enemies = [
  enemy("gloomfang_hound", "Gloomfang Hound", 20, 5, [intent("lunge", "Lunge", 3, "lowestHpHero", [damage(5, "none", "lowestHpHero")]), intent("raking_bite", "Raking Bite", 2, "lowestHpHero", [damage(3, "none", "lowestHpHero"), condition("exposed", "lowestHpHero")]), intent("circle", "Circle", 1, "self", [block(4)])]),
  ...
  enemy("mist_chanter", "Mist Chanter", 22, 2, [intent("dirge", "Dirge", 3, "allAllies", [block(4, "allAllies")], "allyMissingBlock"), intent("borrowed_fury", "Borrowed Fury", 2, "allAllies", [{ kind: "grantNextDamageBonus", target: "allAllies", amount: 2 }], "damagingAllyExists"), intent("lament", "Lament", 1, "allEnemies", [damage(3, "none", "allEnemies", "gloom")])], "tactical_weighted"),
