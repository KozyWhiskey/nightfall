...
const modifierLabels: Record<string, string> = {
  ...
  first_block_plus_2: "+2 Block on the granted card",
  ...
  first_burn_plus_1: "+1 stack on first Burn from the granted card each combat",
  exposed_resource_discount: "First attack vs Exposed each combat costs 1 less secondary",
  retained_resource_discount: "First retained granted card each combat costs 1 less secondary",
